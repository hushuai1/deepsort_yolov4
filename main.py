...
ap.add_argument("-i", "--input",help="path to input video", default = "./test_Trim.mp4")
ap.add_argument("-c", "--class",help="name of class", default = "fish")
...
def main(yolo):
    ...
    # Define the codec and create VideoWriter object
        ...
        out = cv2.VideoWriter('./outputfish.avi', fourcc, 15, (w, h))
